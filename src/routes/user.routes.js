...
route.route("/update-avatar").patch(verifyJWT,upload.single('avatar'),updateAvatar)
route.route("/update-cover").patch(verifyJWT,upload.single("coverimage"),updateCoverImage)
